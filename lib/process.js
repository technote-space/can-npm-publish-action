...
exports.execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield can_npm_publish_1.canNpmPublish(core_1.getInput('PACKAGE_PATH') || undefined, { verbose }).then(() => __awaiter(void 0, void 0, void 0, function* () {
        yield octokit.repos.createStatus(Object.assign(Object.assign({}, context.repo), { sha: exports.getHeadSha(context), state: 'success', description: 'Ready for publishing', context: constant_1.STATUS_CONTEXT }));
        logger.info('passed');
