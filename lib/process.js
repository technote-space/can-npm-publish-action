...
const execute = (logger) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verbose = github_action_helper_1.Utils.getBoolValue((0, core_1.getInput)('VERBOSE'));
    yield (0, can_npm_publish_1.canNpmPublish)((0, core_1.getInput)('PACKAGE_PATH') || undefined, { verbose }).catch((error) => __awaiter(void 0, void 0, void 0, function* () {
