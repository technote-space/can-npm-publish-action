...
exports.execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield octokit.repos.createStatus(Object.assign(Object.assign({}, context.repo), { sha: exports.getHeadSha(context), state: 'pending', context: 'can-npm-publish-action' }));
    ...
    yield can_npm_publish_1.canNpmPublish(core_1.getInput('PACKAGE_PATH'), { verbose }).then(() => __awaiter(void 0, void 0, void 0, function* () {
        yield octokit.repos.createStatus(Object.assign(Object.assign({}, context.repo), { sha: exports.getHeadSha(context), state: 'success', context: 'can-npm-publish-action' }));
        logger.info('passed');
        ...
        yield octokit.repos.createStatus(Object.assign(Object.assign({}, context.repo), { sha: exports.getHeadSha(context), state: 'failure', description: error.message, context: 'can-npm-publish-action' }));
        logger.info('failed');
